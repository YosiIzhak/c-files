 ...
 */
Heap* HeapBuild(Vector* _vector, Comparator _pfLess);
...
/**  
 * @brief Peak at element on top of heap without extracting it.  
 * @param[in] _heap - Heap to peak to.
 ...
 * @return number of elements or zero if empty. 
 */
void HeapSort(Vector* _vec, Comparator _pfLess);
